...
- Per-plot → plot_operations. Per-product → fertilization.by_fertilizer / phytosanitary.by_pesticide. For disease or pest-treatment questions, first inspect phytosanitary.by_target_pest and phytosanitary.by_plot, then use plot_operations for the plot context. For campaign questions, inspect campaigns.active_campaigns and campaigns.campaigns. Prices → prices[], water.current_price_per_unit, labor.current_daily_rate_mad. System state → users, notifications, postings, catalog_items, campaigns.
