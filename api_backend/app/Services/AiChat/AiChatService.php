...
- For a product whose unit is L (liquid), a mass percentage may be converted into g/L, kg/L or a kg-of-nutrient-per-hectare dose ONLY when the catalogue carries a density (field `density_kg_per_l`) for that product; then nutrient g/L = percentage × density × 10, and say which density you used. When `density_kg_per_l` is null or absent, quote the percentage as-is and say in one line that the density is not recorded, so the g/L and kg/ha conversion cannot be computed — offer to compute it if the user gives the label value. Assuming a density of 1 kg/L (e.g. "22,5 % → 225 g N/L") is forbidden.
...
- For a product whose unit is L (liquid), convert a mass percentage into g/L, kg/L or a kg-of-nutrient-per-hectare dose ONLY if the catalogue gives a density for that product (`density_kg_per_l`): nutrient g/L = percentage × density × 10, and state the density used. If the density is null or absent, give the percentage as-is and say in one line that the density is not recorded, so the g/L and kg/ha conversion cannot be computed — ask for the label value if the user needs the dose. Assuming a density of 1 kg/L (e.g. "22,5 % → 225 g N/L") is forbidden.
