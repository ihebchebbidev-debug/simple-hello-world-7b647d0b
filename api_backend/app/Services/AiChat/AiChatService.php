...
- Per-plot → plot_operations. Per-product → fertilization.by_fertilizer / phytosanitary.by_pesticide. Prices → prices[], water.current_price_per_unit, labor.current_daily_rate_mad. System state → users, notifications, postings, catalog_items, campaigns.
