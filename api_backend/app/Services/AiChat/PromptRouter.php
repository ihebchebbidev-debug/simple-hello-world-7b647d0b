...
final class PromptRouter
{
    ...
    private const MAP = [
        ...
        'phytosanitary'     => ['pesticid', 'phyto', 'pest', 'ravageur', 'bioagresseur', 'fongic', 'insectic', 'herbic', 'traitement'],
        ...
        'campaigns'         => ['campaign', 'campagne', 'saison', 'season'],
        'plot_operations'   => ['operation', 'opération', 'operations', 'parcelle', 'plot', 'field'],
